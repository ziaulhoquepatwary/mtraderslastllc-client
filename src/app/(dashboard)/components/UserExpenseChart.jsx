...
import { fetchUserMonthlyExpense } from "@/lib/action/dashboard";
...
export default function UserExpenseChart() {
    ...
    useEffect(() => {
        const getChartData = async () => {
            try {
                setLoading(true);
                const res = await fetchUserMonthlyExpense();
                ...
                console.error("Failed to fetch user expense chart data:", error);
            } finally {
                setLoading(false);
            }
        };
            ...
            <div className="mb-6 flex flex-col items-start justify-between gap-2 sm:flex-row sm:items-center">
                <div>
                    ...
                    <p className="mt-0.5 text-xs text-[#64748B] dark:text-[#94A3B8]">
                        Visual breakdown of your total spending across months
                    </p>
                </div>
            </div>
            ...
            <div className="flex h-[360px] w-full items-center justify-center">
                {loading ? (
                    <div className="flex flex-col items-center justify-center gap-2 text-slate-400">
                        ...
                        <p className="text-xs">Loading expense data...</p>
                    </div>
                ) : isDataEmpty ? (
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                            ...
                            <Bar dataKey="expense" radius={[6, 6, 0, 0]} maxBarSize={45}>
